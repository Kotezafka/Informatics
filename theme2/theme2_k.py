class Chess:
    ...
    def step(self):
        if abs(self.coordinates1 - self.coordinates3) == 1 and abs(self.coordinates2 - self.coordinates4) == 2 or abs(self.coordinates2 - self.coordinates4) == 1 and abs(self.coordinates1 - self.coordinates3) == 2:
            print('YES')
        else:
            print('NO')
