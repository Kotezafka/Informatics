class Chess:
    ...
    def step(self):
        if self.coordinates1 == self.coordinates3 or self.coordinates2 == self.coordinates4 or abs(self.coordinates3 - self.coordinates1) == abs(self.coordinates4 - self.coordinates2):
            print('YES')
        else:
            print('NO')
